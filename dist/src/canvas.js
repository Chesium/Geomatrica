...
class canvas {
    ...
    constructor() {
        ...
        this.stageBound = [
            [0, 0],
            [
                this.PIXIapp.view.offsetWidth - util_js_1.getOffsetLeft(this.PIXIapp.view),
                this.PIXIapp.view.offsetHeight - util_js_1.getOffsetTop(this.PIXIapp.view),
            ],
        ];
        this.tr = [50, 400, 400];
        this.rootObjs = [];
        ...
        this.PIXIapp.renderer.plugins.interaction.on("pointerdown", (event) => {
            ...
            switch (this.mode) {
                ...
                case 1: //画线模式
                    if (FI == -1) {
                        new obj_js_1.obj(this, 1, 0, {
                            p: [
                                new obj_js_1.obj(this, 0, 0, {}, { pos: pos }).geometry,
                                new obj_js_1.obj(this, 0, 0, {}, { pos: pos }).geometry,
                            ],
                        }, {});
                    }
                        ...
                        switch (this.O[FI].geometry.type) {
                            case 0: //从已有点开始画线
                                new obj_js_1.obj(this, 1, 0, {
                                    p: [this.O[FI].geometry, new obj_js_1.obj(this, 0, 0, {}, { pos: pos }).geometry],
                                }, {});
                                break;
                            case 1: //画线时点到线
                                new obj_js_1.obj(this, 1, 0, {
                                    p: [
                                        new obj_js_1.obj(this, 0, 1, { l: this.O[FI].geometry }, { pos: pos }).geometry,
                                        new obj_js_1.obj(this, 0, 0, {}, { pos: pos }).geometry,
                                    ],
                                }, {});
                                break;
                            case 2: //画线时点到圆
                                new obj_js_1.obj(this, 1, 0, {
                                    p: [
                                        new obj_js_1.obj(this, 0, 2, { c: this.O[FI].geometry }, { pos: pos }).geometry,
                                        new obj_js_1.obj(this, 0, 0, {}, { pos: pos }).geometry,
                                    ],
                                }, {});
                                break;
                ...
                case 2: //画点模式
                    if (FI == -1) {
                        new obj_js_1.obj(this, 0, 0, {}, { pos: pos });
                    }
                    else {
                        switch (this.O[FI].geometry.type) {
                            case 0: //画点时点击点
                                break;
                            case 1: //画点时点到线
                                new obj_js_1.obj(this, 0, 1, { l: this.O[FI].geometry }, { pos: pos });
                                break;
                            case 2: //画点时点到圆
                                new obj_js_1.obj(this, 0, 2, { c: this.O[FI].geometry }, { pos: pos });
                                break;
                            default:
                                break;
                        }
            ...
            switch (this.Status) {
                ...
                case 3:
                    ...
                    this.O[this.F].tag.offset.x =
                        event.data.global.x +
                            util_js_1.getOffsetLeft(this.PIXIapp.resizeTo) -
                            this.O[this.F].tag.dragPos[0] +
                            this.O[this.F].tag.dragBeginOffset.x;
                    this.O[this.F].tag.offset.y =
                        event.data.global.y +
                            util_js_1.getOffsetTop(this.PIXIapp.resizeTo) -
    ...
    updAxes() {
        this.axis.clear();
        var origin = this.tran([0, 0], true), dp_Xm = this.stageBound[0][0], dp_Ym = this.stageBound[0][1], dp_Xn = this.stageBound[1][0], dp_Yn = this.stageBound[1][1], minCrd = this.revTran(this.stageBound[0], true), maxCrd = this.revTran(this.stageBound[1], true);
        ...
        if (this.axisXtype != 0) {
            if (origin.y < dp_Ym || origin.y > dp_Yn) {
                ...
                if (this.axisXtype > 1) {
                    //画刻度
                    for (let I = util_js_1.floatMul(Math.ceil(minCrd.x / rsl), rsl); I <= util_js_1.floatMul(Math.floor(maxCrd.x / rsl), rsl); I = util_js_1.floatAdd(I, rsl)) {
                        if (I == 0) {
                            continue;
                        }
            ...
            if (this.axisXtype > 1) {
                ...
                for (let I = util_js_1.floatMul(Math.ceil(minCrd.x / rsl), rsl), i = 1; //i = 0用于原点
                 I <= util_js_1.floatMul(Math.floor(maxCrd.x / rsl), rsl); I = util_js_1.floatAdd(I, rsl)) {
                    if (I == 0) {
                        continue;
                    }
                    // console.log(I);
        ...
        if (this.axisYtype != 0) {
            if (origin.x < dp_Xm || origin.x > dp_Xn) {
                ...
                if (this.axisYtype > 1) {
                    //画刻度
                    for (let I = util_js_1.floatMul(Math.ceil(maxCrd.y / rsl), rsl); I <= util_js_1.floatMul(Math.floor(minCrd.y / rsl), rsl); I = util_js_1.floatAdd(I, rsl)) {
                        if (I == 0) {
                            continue;
                        }
            ...
            if (this.axisYtype > 1) {
                ...
                for (let I = util_js_1.floatMul(Math.ceil(maxCrd.y / rsl), rsl), i = 0; I <= util_js_1.floatMul(Math.floor(minCrd.y / rsl), rsl); I = util_js_1.floatAdd(I, rsl)) {
                    if (I == 0) {
                        continue;
                    }
                    var DPcrd_t = this.tran([0, I]);
        ...
        if (this.axisXtype > 1 || this.axisYtype > 1) {
            ...
            if (this.Xscale[0] === undefined) {
                this.Xscale[0] = new PIXI.Text("", this.scaleFont);
