...
const Points = require("./point/Points.js");
const Lines = require("./line/Lines.js");
const Circles = require("./circle/Circles.js");
function geometryFromType(type, dfnType, dfn, initData, obj) {
    switch (type) {
        case 0: //点
            switch (dfnType) {
                case 0:
...
exports.default = geometryFromType;
