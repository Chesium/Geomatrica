            ...
            case 0: //点
                switch (this.dfnType) {
                    case 0: //自由点
                        ...
                        break;
                    case 1: //线上的点
                        var a = this.dfn.l.data.a, b = this.dfn.l.data.b, c = this.dfn.l.data.c, d = this.dfn.l.data.d, r = this.dfn.l.data.r, t1 = this.dfn.l.cache.p[0], t2 = this.dfn.l.cache.p[1];
                    ...
                    case 3: //两线交点
                        ...
                        var a1 = this.dfn.l[0].data.a, b1 = this.dfn.l[0].data.b, c1 = this.dfn.l[0].data.c, d1 = this.dfn.l[0].data.d, r1 = this.dfn.l[0].data.r, a2 = this.dfn.l[1].data.a, b2 = this.dfn.l[1].data.b, c2 = this.dfn.l[1].data.c, d2 = this.dfn.l[1].data.d, r2 = this.dfn.l[1].data.r;
                        if (a1 * c2 == a2 * c1) {
                            //两线平行无交点
                            this.data.exist = false;
                            return;
                        }
                        var t1 = (b2 * c2 - b1 * c2 + a2 * d1 - a2 * d2) / (a1 * c2 - a2 * c1), t2 = (b2 * c1 - b1 * c1 + a1 * d1 - a1 * d2) / (a1 * c2 - a2 * c1);
                        ...
                        break;
                    case 4: //两圆的第一个交点
                        var x1 = this.dfn.c[0].data.x, y1 = this.dfn.c[0].data.y, r1 = this.dfn.c[0].data.r, x2 = this.dfn.c[1].data.x, y2 = this.dfn.c[1].data.y, r2 = this.dfn.c[1].data.r;
                        ...
                        var p = s * n;
                        var xM = x1 + n * (x2 - x1), yM = y1 + n * (y2 - y1);
                    ...
                    case 5: //两圆的第二个交点
                        ...
                        break;
                    case 6: //圆与线的第一个交点
                        var a = this.dfn.l.data.a, b = this.dfn.l.data.b, c = this.dfn.l.data.c, d = this.dfn.l.data.d, rg = this.dfn.l.data.r, //range of t
                        x = this.dfn.c.data.x, y = this.dfn.c.data.y, r = this.dfn.c.data.r;
                        var A = a * a + c * c, B = 2 * (a * (b - x) + c * (d - y)), C = b * b + d * d + x * x + y * y - r * r - 2 * (b * x + d * y);
            ...
            case 1: //线
                ...
                switch (this.dfnType) {
                    ...
                    case 2: //射线
                        ...
                        break;
                    case 3: //垂线
                        var x = this.dfn.p.data.x, y = this.dfn.p.data.y, a = this.dfn.l.data.a, b = this.dfn.l.data.b, c = this.dfn.l.data.c, d = this.dfn.l.data.d;
                        if (c == 0) {
                            //[-]->[|]
                            this.data.exist = true;
                            this.data.a = 0;
...
//# sourceMappingURL=geometry%20copy.js.map