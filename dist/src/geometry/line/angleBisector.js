...
exports.angleBisector_3 = exports.angleBisector_2 = exports.angleBisector_1 = void 0;
const geometryBase_js_1 = require("../geometryBase.js");
const util_js_1 = require("../../util.js");
const pObj_js_1 = require("../../pObj.js");
class angleBisector_1 extends geometryBase_js_1.default {
    ...
    calcData() {
        ...
        var x0 = this.dfn.p[0].data.x, y0 = this.dfn.p[0].data.y, x1 = this.dfn.p[1].data.x, y1 = this.dfn.p[1].data.y, x2 = this.dfn.p[2].data.x, y2 = this.dfn.p[2].data.y;
        var l01 = (x0 - x1) * (x0 - x1) + (y0 - y1) * (y0 - y1), l21 = (x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1);
        var k = 1 / (Math.sqrt(l01 / l21) + 1); // 0M:02
        var xm = x2 - k * (x2 - x0), ym = y2 - k * (y2 - y0);
        if (x1 == xm && y1 == ym) {
            //x0、x1、x2共线，让0绕1顺转90°
            xm = x1 + y1 - y0;
            ym = y1 - x1 + x0;
...
exports.angleBisector_1 = angleBisector_1;
class angleBisector_2 extends geometryBase_js_1.default {
}
exports.angleBisector_2 = angleBisector_2;
class angleBisector_3 extends geometryBase_js_1.default {
}
exports.angleBisector_3 = angleBisector_3;
